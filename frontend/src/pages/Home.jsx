  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="px-4 py-6">
        ...
        <p className="text-2xl font-bold text-gray-800 mb-2">Upcoming IPO</p>
      ...
      <div className="grid grid-cols-3 gap-8 justify-items-center">
        {companies.map(company => (
          <div key={company.id}
            className="bg-white shadow-lg rounded-xl p-6 flex flex-col items-center w-110 h-100 transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
